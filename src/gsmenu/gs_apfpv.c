...
void create_apfpv_menu(lv_obj_t * parent) {
    ...
    ap_fpv_ssid = create_textarea(cont, "Loading ...", "SSID", "ssid", menu_page_data, false);
    ap_fpv_password = create_textarea(cont, "Loading ...", "Password", "password", menu_page_data, true);
